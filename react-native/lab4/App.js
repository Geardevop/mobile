...
export default function App() {
  ...
  if (correctNumber > 0 && guessRounds <= 0) {
    ...
    content = (
      <GameScreen onGameOver={gameOverHandler} correctNumber={correctNumber}/>
    );
  } else if (guessRounds > 0) {
    // ทำการเรียก GameOverScreen
    content = (
      <GameOverScreen round={guessRounds} correctNumber={correctNumber} onGameRestart={configureNewGameHandler} />
    );
  }
